...
import { Users, Package, FileText, ShoppingCart, Calculator, Target, BarChart3, Warehouse, Store, Factory, Users2, Globe, FolderKanban, ListChecks, Route, Wrench, Tag, ArrowRight } from "lucide-react";
...
const MODULES = [
  ...
  { href: "/shop/marketing", label: "การตลาด/แต้ม", desc: "โปรโมชั่น/ส่วนลด + สะสมแต้ม", icon: Tag },
